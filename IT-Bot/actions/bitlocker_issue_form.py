...
class BitlockerIssueForm(FormAction):
    """Example of a custom form action"""

    def name(self) -> Text:
        """Unique identifier of the form"""
        
        return "bitlocker_issue_form"
    ...
    def submit(
        ...
        link = ""
        guide = '<a href="file://10.197.192.69/Common/IT/Helpdesk%20Doc/ChatBot/Bitlocker%20Support.docx" target="_blank"><b>Bitlocker Support Guide</b></a>'
        response = 'Here is a guide which will help you to reset Bit locker PIN. <br><br>{}'.format(guide)
