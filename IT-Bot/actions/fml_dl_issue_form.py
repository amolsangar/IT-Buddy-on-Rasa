...
class FmbDlIssueForm(FormAction):
    """Example of a custom form action"""

    def name(self) -> Text:
        """Unique identifier of the form"""
        
        return "fml_dl_issue_form"
    ...
    def submit(
        ...
        link = ""
        guide = '<a href="https://yam.telekom.de/docs/DOC-458807" target="_blank"><b>FMB and DL Support Guide</b></a>'
        response = 'Please refer below link for your queries related to FMB and DL Support <br><br>{}'.format(guide)
