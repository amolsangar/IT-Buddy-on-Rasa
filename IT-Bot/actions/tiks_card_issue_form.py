...
class TiksCardIssueForm(FormAction):
    """Example of a custom form action"""

    def name(self) -> Text:
        """Unique identifier of the form"""
        
        return "tiks_card_issue_form"
    ...
    def submit(
        ...
        link = ""
        guide = '<a href="file://10.197.192.69/Common/IT/Helpdesk%20Doc/ChatBot/How%20to%20Unlock%20the%20TIKS%20Card.pdf" target="_blank"><b>How to Unlock the TIKS Card Guide</b></a>'
        response = 'Here is a guide to reset/unlock TIKS Card PIN. <br>{}'.format(guide)
